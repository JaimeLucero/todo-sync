...
# Install: brew tap yourname/todo-sync && brew install todo-sync

class TodoSync < Formula
  desc "Bidirectional sync between TODO.md and GitHub Issues"
  homepage "https://github.com/yourname/todo-sync"
  url "https://github.com/yourname/todo-sync/archive/refs/tags/v1.0.0.tar.gz"
